...
@section('content')
    ...
    <div class="card card-primary card-outline mb-4">
        <div class="card-header d-flex justify-content-end align-items-center">
            <a href="{{ route('admin.blog-categories.index') }}" class="btn btn-primary btn-sm"><i class="bi bi-arrow-left-circle me-1"></i> Back To List</a>
        </div>
        <div class="card-body">
            <form
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        @if(isset($blogcategory) && $blogcategory->banner)
                            <img src="{{ image_url('banner' , $blogcategory->banner, 'small') }}" alt="Image" class="mt-2" width="50">
                        @endif
                    ...
                    <div class="mb-3 col-md-6">
                        <div class="form-check form-switch mb-3">
                            ...
                            <input class="form-check-input" type="checkbox" name="status" value="1" id="statusSwitch" {{ old('status', $blogcategory->status ?? true) ? 'checked' : '' }} />
