                    ...
                    <tbody>
                        @if(old('actions', $coupon->actions ?? []))
                            @foreach(old('actions', $coupon->actions ?? []) as $i => $action)
                                <tr>
                                    <td>
                                        <select name="actions[{{ $i }}][action]" class="form-select">
                                            @foreach(['fixed_discount', 'percentage_discount', 'free_product', 'discount_product'] as $a)
...
<script>
    ...
    <script>
        ...
        $('#add-action').click(function () {
            let row = `<tr>
                        <td>
                            <select name="actions[${actionIndex}][action]" class="form-select">
